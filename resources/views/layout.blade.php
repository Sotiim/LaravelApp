...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">SmarTNG</a>
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('create-persona') }}"> Agregar un profesor</a>
                <a class="dropdown-item" href="{{ URL::to('all-personas') }}"> Todos los profesor</a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('create-multimedia') }}"> Agregar Multimedia</a>
                <a class="dropdown-item" href="{{ URL::to('all-multimedia') }}"> Toda la Multimedia</a>
